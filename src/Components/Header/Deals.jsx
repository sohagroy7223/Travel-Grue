  ...
  return (
    <div className="mt-15">
      <div className="text-center">
        <h2 className="md:text-3xl text-2xl font-bold">Deals & Discounts</h2>
      ...
      <div
        className="hero md:h-100 mt-8 h-90 rounded-lg col-span-5"
        style={{
          backgroundImage: "url(https://i.ibb.co.com/V0SdFSyf/Bergen.webp)",
        }}
      >
        <div className=" bg-white/70 backdrop-blur-[2px] absolute border p-5 space-y-3 md:-ml-120 md:mt-1 w-80 md:w-120 rounded-2xl ">
          <div className="flex items-center gap-2  ">
      ...
      <div className="w-full flex justify-center">
        <button className="bg-primary text-base-100 btn  mt-12">
          See All Packages
        </button>
      </div>
    </div>
